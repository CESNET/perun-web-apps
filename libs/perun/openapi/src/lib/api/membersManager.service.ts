...
// @ts-ignore
import { RegistrarApplicationInput } from '../model/registrarApplicationInput';
// @ts-ignore
...
export class MembersManagerService {
  ...
  /**
   * Checks if the caller can apply for membership in VO, throws error containing the reason if cannot be member.
   * @param vo id of Vo
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public canCallerBeMemberWithReason(
    vo: number,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public canCallerBeMemberWithReason(
    ...
    if (vo === null || vo === undefined) {
      throw new Error(
        'Required parameter vo was null or undefined when calling canCallerBeMemberWithReason.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/membersManager/canCallerBeMemberWithReason`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
  ...
  /**
   * Return true if the membership can be extended or if no rules were set for the membershipExpiration, otherwise throws an exception containing the reason.
   * @param member id of Member
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public canExtendInNewRegistrar(
    member: number,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public canExtendInNewRegistrar(
    ...
    if (member === null || member === undefined) {
      throw new Error(
        'Required parameter member was null or undefined when calling canExtendInNewRegistrar.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/membersManager/canExtendInNewRegistrar`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
  ...
  /**
   * Creates a member based on data from an initial registrar application.
   * Creates a member based on a registrar application with OIDC authentication.
   * @param RegistrarApplicationInput
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public createMemberFromInitialRegistrarApplication(
    RegistrarApplicationInput: RegistrarApplicationInput,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public createMemberFromInitialRegistrarApplication(
    ...
    if (RegistrarApplicationInput === null || RegistrarApplicationInput === undefined) {
      throw new Error(
        'Required parameter RegistrarApplicationInput was null or undefined when calling createMemberFromInitialRegistrarApplication.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/membersManager/createMemberFromInitialRegistrarApplication`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
    ...
    return this.httpClient.post<Member>(requestUrl, RegistrarApplicationInput, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: localVarHeaders,
  ...
  /**
   * Extends a membership based on data from an initial registrar application.
   * Extends a membership based on a registrar application with OIDC authentication.
   * @param RegistrarApplicationInput
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public extendMembershipFromExtensionRegistrarApplication(
    RegistrarApplicationInput: RegistrarApplicationInput,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public extendMembershipFromExtensionRegistrarApplication(
    ...
    if (RegistrarApplicationInput === null || RegistrarApplicationInput === undefined) {
      throw new Error(
        'Required parameter RegistrarApplicationInput was null or undefined when calling extendMembershipFromExtensionRegistrarApplication.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/membersManager/extendMembershipFromExtensionRegistrarApplication`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
  ...
  /**
   * Returns a Member specified by VO id and User ID. Returns null if the Member does not exist.
   * @param vo id of Vo
   * @param user id of User
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getMemberByUserIfExists(
    vo: number,
    user: number,
    useNon?: boolean,
    observe?: 'body',
  ...
  public getMemberByUserIfExists(
    ...
    if (vo === null || vo === undefined) {
      throw new Error(
        'Required parameter vo was null or undefined when calling getMemberByUserIfExists.',
      );
    }
    if (user === null || user === undefined) {
      throw new Error(
        'Required parameter user was null or undefined when calling getMemberByUserIfExists.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/membersManager/getMemberByUserIfExists`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
  ...
  /**
   * Returns RichMember with attributes by the users\&#39; uuid and the vo.
   * Gets RichMember by uuid
   * @param vo id of Vo
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getRichMemberByUserUUID(
    vo: number,
    uuid: string,
    attrNames?: Array<string>,
    useNon?: boolean,
  ...
  public getRichMemberByUserUUID(
    ...
    if (vo === null || vo === undefined) {
      throw new Error(
        'Required parameter vo was null or undefined when calling getRichMemberByUserUUID.',
      );
    }
    if (uuid === null || uuid === undefined) {
      throw new Error(
        'Required parameter uuid was null or undefined when calling getRichMemberByUserUUID.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/membersManager/getRichMemberByUserUUID`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
  ...
  /**
   * Retrieve service user RichMembers from a VO.
   * @param vo id of Vo
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getServiceUserRichMembers(
    vo: number,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public getServiceUserRichMembers(
    ...
    if (vo === null || vo === undefined) {
      throw new Error(
        'Required parameter vo was null or undefined when calling getServiceUserRichMembers.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/membersManager/getServiceUserRichMembers`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
