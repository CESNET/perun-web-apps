...
// @ts-ignore
import { InputRemoveMembers } from '../model/inputRemoveMembers';
// @ts-ignore
...
export class GroupsManagerService {
  ...
  /**
   * Returns true if member in given group can extend membership or if no rules were set for the membershipExpiration, otherwise throws exception containing the reason.
   * @param member id of Member
   * @param group id of Group
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public canExtendInNewRegistrarGroup(
    member: number,
    group: number,
    useNon?: boolean,
    observe?: 'body',
  ...
  public canExtendInNewRegistrarGroup(
    ...
    if (member === null || member === undefined) {
      throw new Error(
        'Required parameter member was null or undefined when calling canExtendInNewRegistrarGroup.',
      );
    }
    if (group === null || group === undefined) {
      throw new Error(
        'Required parameter group was null or undefined when calling canExtendInNewRegistrarGroup.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/groupsManager/canExtendInNewRegistrarGroup`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
  ...
  /**
   * Returns all groups in a VO the user has access to.
   * @param vo id of Vo
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
  ...
  public getAllMyGroups(
    ...
    if (vo === null || vo === undefined) {
      throw new Error('Required parameter vo was null or undefined when calling getAllMyGroups.');
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/groupsManager/getGroups`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
  ...
  public getGroupByUUID(
    ...
    let requestUrl = `${this.configuration.basePath}/json/groupsManager/getGroupByUUID`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
  ...
  public getSubGroups(
    ...
    if (parentGroup === null || parentGroup === undefined) {
      throw new Error(
        'Required parameter parentGroup was null or undefined when calling getSubGroups.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/groupsManager/getSubGroups`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public isGroupLastAdminInSomeFacility(
    groups: Array<number>,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public isGroupLastAdminInSomeFacility(
    ...
    if (groups === null || groups === undefined) {
      throw new Error(
        'Required parameter groups was null or undefined when calling isGroupLastAdminInSomeFacility.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/groupsManager/isGroupLastAdminInSomeFacility`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
  ...
  /**
   * Returns groups which supply the last VOADMIN in some VO.
   * @param groups list of Group ids List&lt;Integer&gt;
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public isGroupLastAdminInSomeVo(
    groups: Array<number>,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public isGroupLastAdminInSomeVo(
    ...
    if (groups === null || groups === undefined) {
      throw new Error(
        'Required parameter groups was null or undefined when calling isGroupLastAdminInSomeVo.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/groupsManager/isGroupLastAdminInSomeVo`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public isSuspendedGroupSynchronization(
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public isSuspendedGroupSynchronization(
    ...
    let requestUrl = `${this.configuration.basePath}/json/groupsManager/isSuspendedGroupSynchronization`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
  ...
  /**
   * Removes unions of groups, where \&quot;operandGroups\&quot; are technically removed from subgroups of \&quot;resultGroup\&quot;. Members from \&quot;operandGroups\&quot; are removed from \&quot;resultGroup\&quot; if they were INDIRECT members sourcing from these groups only.
   * @param resultGroup id of Group to have removed \&#39;operandGroup\&#39; from subgroups
   * @param operandGroups IDs of Groups to be removed from \&#39;resultGroup\&#39; subgroups
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public removeGroupUnions(
    resultGroup: number,
    operandGroups: Array<number>,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public removeGroupUnions(
    ...
    if (resultGroup === null || resultGroup === undefined) {
      throw new Error(
        'Required parameter resultGroup was null or undefined when calling removeGroupUnions.',
      );
    }
    if (operandGroups === null || operandGroups === undefined) {
      throw new Error(
        'Required parameter operandGroups was null or undefined when calling removeGroupUnions.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/urlinjsonout/groupsManager/removeGroupUnions`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
  ...
  /**
   * Removes members from a group. Non-empty list of members expected. In case of empty list, no member is removed from the group. If member is not in the group or the membership is indirect, it is skipped without a warning but the rest of the members are processed. Copy of the removeMembers call with parameters in the request body.
   * @param InputRemoveMembers
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public removeMembersBodyParams(
    InputRemoveMembers: InputRemoveMembers,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public removeMembersBodyParams(
    ...
    if (InputRemoveMembers === null || InputRemoveMembers === undefined) {
      throw new Error(
        'Required parameter InputRemoveMembers was null or undefined when calling removeMembersBodyParams.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/groupsManager/removeMembers`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
    ...
    return this.httpClient.post<any>(requestUrl, InputRemoveMembers, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: localVarHeaders,
  ...
  /**
   * Resumes previously suspended group synchronization
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public resumeGroupSynchronization(
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public resumeGroupSynchronization(
    ...
    let requestUrl = `${this.configuration.basePath}/urlinjsonout/groupsManager/resumeGroupSynchronization`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
  ...
  /**
   * Suspends group synchronization. Groups being currently synchronized will finish.
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public suspendGroupSynchronization(
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public suspendGroupSynchronization(
    ...
    let requestUrl = `${this.configuration.basePath}/urlinjsonout/groupsManager/suspendGroupSynchronization`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
