...
export class InvitationsManagerService {
  ...
  public canInvitationBeAccepted(
    ...
    let localVarPath = `/urlinjsonout/invitationsManager/canInvitationBeAccepted`;
    return this.httpClient.request<Invitation>(
      'get',
  ...
  public extendInvitationExpiration(
    ...
    let localVarPath = `/urlinjsonout/invitationsManager/extendInvitationExpiration`;
    return this.httpClient.request<Invitation>(
      'post',
      `${this.configuration.basePath}${localVarPath}`,
      {
  ...
  public extendInvitationExpirationByUUID(
    ...
    let localVarPath = `/urlinjsonout/invitationsManager/extendInvitationExpirationByUUID`;
    return this.httpClient.request<Invitation>(
      'post',
      `${this.configuration.basePath}${localVarPath}`,
      {
  ...
  public getInvitationById(
    ...
    let localVarPath = `/json/invitationsManager/getInvitationById`;
    return this.httpClient.request<Invitation>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
  ...
  public inviteToGroup(
    ...
    let localVarPath = `/urlinjsonout/invitationsManager/inviteToGroup`;
    return this.httpClient.request<Invitation>(
      'post',
      `${this.configuration.basePath}${localVarPath}`,
      {
  ...
  public inviteToGroupFromCsv(
    ...
    let localVarPath = `/json/invitationsManager/inviteToGroupFromCsv`;
    return this.httpClient.request<{ [key: string]: string }>(
      'post',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
        body: inputInviteToGroupFromCsv,
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
        headers: localVarHeaders,
        observe: observe,
  ...
  public revokeInvitationById(
    ...
    let localVarPath = `/urlinjsonout/invitationsManager/revokeInvitationById`;
    return this.httpClient.request<Invitation>(
      'post',
      `${this.configuration.basePath}${localVarPath}`,
      {
  ...
  public revokeInvitationByUuid(
    ...
    let localVarPath = `/urlinjsonout/invitationsManager/revokeInvitationByUuid`;
    return this.httpClient.request<Invitation>(
      'post',
      `${this.configuration.basePath}${localVarPath}`,
      {
