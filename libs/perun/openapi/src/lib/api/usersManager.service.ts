...
// @ts-ignore
import { AddUserExtSourceWithAttributesInput } from '../model/addUserExtSourceWithAttributesInput';
// @ts-ignore
import { BlockedLogin } from '../model/blockedLogin';
// @ts-ignore
import { DeleteReservedLoginRequest } from '../model/deleteReservedLoginRequest';
// @ts-ignore
import { Group } from '../model/group';
// @ts-ignore
import { InputBlockLogins } from '../model/inputBlockLogins';
// @ts-ignore
...
// @ts-ignore
import { InputUnblockLogins } from '../model/inputUnblockLogins';
// @ts-ignore
import { InputUnblockLoginsById } from '../model/inputUnblockLoginsById';
// @ts-ignore
...
// @ts-ignore
import { PerunBean } from '../model/perunBean';
// @ts-ignore
import { PerunException } from '../model/perunException';
// @ts-ignore
import { ReserveLoginForUserRequest } from '../model/reserveLoginForUserRequest';
// @ts-ignore
import { ReserveLoginRequest } from '../model/reserveLoginRequest';
// @ts-ignore
...
export class UsersManagerService {
  ...
  /**
   * Adds user\&#39;s external source along with the given attributes.
   * @param AddUserExtSourceWithAttributesInput
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public addUserExtSourceWithAttributes(
    AddUserExtSourceWithAttributesInput: AddUserExtSourceWithAttributesInput,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public addUserExtSourceWithAttributes(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<RichUserExtSource>>;
  public addUserExtSourceWithAttributes(
    AddUserExtSourceWithAttributesInput: AddUserExtSourceWithAttributesInput,
    useNon?: boolean,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<RichUserExtSource>>;
  public addUserExtSourceWithAttributes(
    AddUserExtSourceWithAttributesInput: AddUserExtSourceWithAttributesInput,
    useNon: boolean = false,
    observe: any = 'body',
    ...
    if (
      AddUserExtSourceWithAttributesInput === null ||
      AddUserExtSourceWithAttributesInput === undefined
    ) {
      throw new Error(
        'Required parameter AddUserExtSourceWithAttributesInput was null or undefined when calling addUserExtSourceWithAttributes.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/usersManager/addUserExtSourceWithAttributes`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
    ...
    return this.httpClient.post<RichUserExtSource>(
      requestUrl,
  ...
  /**
   * Block logins for given namespace or block logins globally (if no namespace is selected). Copy of the blockLogins call with parameters in the request body.
   * @param InputBlockLogins
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public blockLoginsBodyParams(
    InputBlockLogins: InputBlockLogins,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public blockLoginsBodyParams(
    ...
    if (InputBlockLogins === null || InputBlockLogins === undefined) {
      throw new Error(
        'Required parameter InputBlockLogins was null or undefined when calling blockLoginsBodyParams.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/usersManager/blockLogins`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
    ...
    return this.httpClient.post<any>(requestUrl, InputBlockLogins, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: localVarHeaders,
   ...
   * @param user id of User
   * @param newEmail new email which will be set
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  ...
  public changeEmail(
    ...
    if (user === null || user === undefined) {
      throw new Error('Required parameter user was null or undefined when calling changeEmail.');
    }
    if (newEmail === null || newEmail === undefined) {
      throw new Error(
        'Required parameter newEmail was null or undefined when calling changeEmail.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/urlinjsonout/usersManager/changeEmail`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
  ...
  public changeEmailCustom(
    ...
    if (user === null || user === undefined) {
      throw new Error(
        'Required parameter user was null or undefined when calling changeEmailCustom.',
      );
    }
    if (newEmail === null || newEmail === undefined) {
      throw new Error(
        'Required parameter newEmail was null or undefined when calling changeEmailCustom.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/urlinjsonout/usersManager/changeEmailCustom`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
   ...
   * @param user id of User
   * @param newUserName new user\&#39;s name which will be set
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  ...
  public changeName(
    ...
    if (user === null || user === undefined) {
      throw new Error('Required parameter user was null or undefined when calling changeName.');
    }
    if (newUserName === null || newUserName === undefined) {
      throw new Error(
        'Required parameter newUserName was null or undefined when calling changeName.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/urlinjsonout/usersManager/changeName`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
   ...
   * @param user id of User
   * @param titleBefore new title before which will be set
   * @param firstName new first name which will be set
   * @param middleName new middle name which will be set
   * @param lastName new last name which will be set
   * @param titleAfter new title after which will be set
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public changeNameCustom(
    user: number,
    titleBefore: string,
    firstName: string,
    middleName: string,
  ...
  public changeNameCustom(
    ...
    if (user === null || user === undefined) {
      throw new Error(
        'Required parameter user was null or undefined when calling changeNameCustom.',
      );
    }
    if (titleBefore === null || titleBefore === undefined) {
      throw new Error(
        'Required parameter titleBefore was null or undefined when calling changeNameCustom.',
      );
    }
    if (firstName === null || firstName === undefined) {
      throw new Error(
        'Required parameter firstName was null or undefined when calling changeNameCustom.',
      );
    }
    if (middleName === null || middleName === undefined) {
      throw new Error(
        'Required parameter middleName was null or undefined when calling changeNameCustom.',
      );
    }
    if (lastName === null || lastName === undefined) {
      throw new Error(
        'Required parameter lastName was null or undefined when calling changeNameCustom.',
      );
    }
    if (titleAfter === null || titleAfter === undefined) {
      throw new Error(
        'Required parameter titleAfter was null or undefined when calling changeNameCustom.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/urlinjsonout/usersManager/changeNameCustom`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
   ...
   * @param user id of User
   * @param newOrganizationName name of new organization which will be set
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  ...
  public changeOrganization(
    ...
    if (user === null || user === undefined) {
      throw new Error(
        'Required parameter user was null or undefined when calling changeOrganization.',
      );
    }
    if (newOrganizationName === null || newOrganizationName === undefined) {
      throw new Error(
        'Required parameter newOrganizationName was null or undefined when calling changeOrganization.',
      );
    }
    ...
    if (newOrganizationName !== undefined && newOrganizationName !== null) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
    ...
    let requestUrl = `${this.configuration.basePath}/urlinjsonout/usersManager/changeOrganization`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public changeOrganizationCustom(
    user: number,
    newOrganizationName: string,
    useNon?: boolean,
    observe?: 'body',
  ...
  public changeOrganizationCustom(
    ...
    if (user === null || user === undefined) {
      throw new Error(
        'Required parameter user was null or undefined when calling changeOrganizationCustom.',
      );
    }
    if (newOrganizationName === null || newOrganizationName === undefined) {
      throw new Error(
        'Required parameter newOrganizationName was null or undefined when calling changeOrganizationCustom.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/urlinjsonout/usersManager/changeOrganizationCustom`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
   ...
   * @param DeleteReservedLoginRequest
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public deleteReservedLogin(
    DeleteReservedLoginRequest: DeleteReservedLoginRequest,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public deleteReservedLogin(
    ...
    if (DeleteReservedLoginRequest === null || DeleteReservedLoginRequest === undefined) {
      throw new Error(
        'Required parameter DeleteReservedLoginRequest was null or undefined when calling deleteReservedLogin.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/usersManager/deleteReservedLogin`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
    ...
    return this.httpClient.post<any>(requestUrl, DeleteReservedLoginRequest, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: localVarHeaders,
  ...
  /**
   * Get all rich resources where the user is assigned. The user has a membership in a group with an active assignment to the resource. No filter is applied on their VO membership status.
   * @param user id of User
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
  ...
  /**
   * Return all users who owns the specific user and are not anonymized.
   * @param specificUser id of specific User
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getUnanonymizedUsersBySpecificUser(
    specificUser: number,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public getUnanonymizedUsersBySpecificUser(
    ...
    if (specificUser === null || specificUser === undefined) {
      throw new Error(
        'Required parameter specificUser was null or undefined when calling getUnanonymizedUsersBySpecificUser.',
      );
    }
  ...
  public getUserRelations(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<{ [key: string]: Array<PerunBean> }>;
  public getUserRelations(
    user: number,
    useNon?: boolean,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<{ [key: string]: Array<PerunBean> }>>;
  public getUserRelations(
    user: number,
    useNon?: boolean,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<{ [key: string]: Array<PerunBean> }>>;
  public getUserRelations(
    user: number,
    useNon: boolean = false,
    observe: any = 'body',
    ...
    if (user === null || user === undefined) {
      throw new Error(
        'Required parameter user was null or undefined when calling getUserRelations.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/usersManager/getUserRelations`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
    ...
    return this.httpClient.get<{ [key: string]: Array<PerunBean> }>(requestUrl, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
  ...
  /**
   * Move UserExtSource from one user to another
  ...
  public moveUserExtSource(
    ...
    if (sourceUser === null || sourceUser === undefined) {
      throw new Error(
        'Required parameter sourceUser was null or undefined when calling moveUserExtSource.',
      );
    }
    if (targetUser === null || targetUser === undefined) {
      throw new Error(
        'Required parameter targetUser was null or undefined when calling moveUserExtSource.',
      );
    }
    if (userExtSource === null || userExtSource === undefined) {
      throw new Error(
        'Required parameter userExtSource was null or undefined when calling moveUserExtSource.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/urlinjsonout/usersManager/moveUserExtSource`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
  ...
  /**
   * Reserve login in a namespace for given identifier and issuer.
   * @param ReserveLoginRequest
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public reserveLogin(
    ReserveLoginRequest: ReserveLoginRequest,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public reserveLogin(
    ...
    if (ReserveLoginRequest === null || ReserveLoginRequest === undefined) {
      throw new Error(
        'Required parameter ReserveLoginRequest was null or undefined when calling reserveLogin.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/usersManager/reserveLogin`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
    ...
    return this.httpClient.post<any>(requestUrl, ReserveLoginRequest, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: localVarHeaders,
  ...
  /**
   * Reserve login in a namespace for given userId.
   * @param ReserveLoginForUserRequest
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public reserveLoginForUser(
    ReserveLoginForUserRequest: ReserveLoginForUserRequest,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public reserveLoginForUser(
    ...
    if (ReserveLoginForUserRequest === null || ReserveLoginForUserRequest === undefined) {
      throw new Error(
        'Required parameter ReserveLoginForUserRequest was null or undefined when calling reserveLoginForUser.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/usersManager/reserveLogin/user`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
    ...
    return this.httpClient.post<any>(requestUrl, ReserveLoginForUserRequest, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: localVarHeaders,
  ...
  /**
   * Set specific user type for specific user and set ownership of this user to the owner.
   * @param specificUser id of specific user
   * @param specificUserType specific type of user
   * @param owner id of user, who will be owner of the specific user
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public setSpecificUser(
    specificUser: number,
    specificUserType: 'SERVICE' | 'SPONSORED' | 'NORMAL',
    owner: number,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public setSpecificUser(
    ...
    if (specificUser === null || specificUser === undefined) {
      throw new Error(
        'Required parameter specificUser was null or undefined when calling setSpecificUser.',
      );
    }
    if (specificUserType === null || specificUserType === undefined) {
      throw new Error(
        'Required parameter specificUserType was null or undefined when calling setSpecificUser.',
      );
    }
    if (owner === null || owner === undefined) {
      throw new Error(
        'Required parameter owner was null or undefined when calling setSpecificUser.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/urlinjsonout/usersManager/setSpecificUser`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
    ...
    return this.httpClient.post<User>(requestUrl, null, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
  ...
  /**
   * Unblock logins for given namespace or unblock logins globally (if no namespace is selected). Copy of the unblockLogins call with parameters in the request body.
   * @param InputUnblockLogins
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public unblockLoginsBodyParams(
    InputUnblockLogins: InputUnblockLogins,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public unblockLoginsBodyParams(
    ...
    if (InputUnblockLogins === null || InputUnblockLogins === undefined) {
      throw new Error(
        'Required parameter InputUnblockLogins was null or undefined when calling unblockLoginsBodyParams.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/usersManager/unblockLogins`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
    ...
    return this.httpClient.post<any>(requestUrl, InputUnblockLogins, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: localVarHeaders,
  ...
  /**
   * Unblock logins by id. Copy of the unblockLoginsById call with parameters in the request body.
   * @param InputUnblockLoginsById
   * @param useNon if set to true sends the request to the backend server as 'non' instead of the usual (oauth, krb...).
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public unblockLoginsByIdBodyParams(
    InputUnblockLoginsById: InputUnblockLoginsById,
    useNon?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public unblockLoginsByIdBodyParams(
    ...
    if (InputUnblockLoginsById === null || InputUnblockLoginsById === undefined) {
      throw new Error(
        'Required parameter InputUnblockLoginsById was null or undefined when calling unblockLoginsByIdBodyParams.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/json/usersManager/unblockLoginsById`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
    ...
    return this.httpClient.post<any>(requestUrl, InputUnblockLoginsById, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: localVarHeaders,
  ...
  public unsetSpecificUser(
    ...
    if (specificUser === null || specificUser === undefined) {
      throw new Error(
        'Required parameter specificUser was null or undefined when calling unsetSpecificUser.',
      );
    }
    if (specificUserType === null || specificUserType === undefined) {
      throw new Error(
        'Required parameter specificUserType was null or undefined when calling unsetSpecificUser.',
      );
    }
    ...
    let requestUrl = `${this.configuration.basePath}/urlinjsonout/usersManager/unsetSpecificUser`;
    if (useNon) {
      // replace the authentication part of url with 'non' authentication
      let helperUrl = new URL(requestUrl);
      let path = helperUrl.pathname.split('/');
