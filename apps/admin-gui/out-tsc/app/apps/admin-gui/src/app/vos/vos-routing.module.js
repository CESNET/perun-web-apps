...
import { GroupSettingsAttributesComponent } from './pages/group-detail-page/group-settings/group-settings-attributes/group-settings-attributes.component';
...
import { MemberSettingsOverviewComponent } from './pages/member-detail-page/member-settings/member-settings-overview/member-settings-overview.component';
import { MemberSettingsAttributesComponent } from './pages/member-detail-page/member-settings/member-settings-attributes/member-settings-attributes.component';
...
VosRoutingModule = __decorate([
    NgModule({
        imports: [RouterModule.forChild(routes)],
        exports: [RouterModule]
    })
], VosRoutingModule);
export { VosRoutingModule };
//# sourceMappingURL=vos-routing.module.js.map