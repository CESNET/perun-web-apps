...
import { FacilitySettingsAttributesComponent } from './pages/facility-detail-page/facility-settings/facility-settings-attributes/facility-settings-attributes.component';
...
import { ResourceSettingsAttributesComponent } from './pages/resource-detail-page/resource-settings/resource-settings-attributes/resource-settings-attributes.component';
...
FacilitiesRoutingModule = __decorate([
    NgModule({
        imports: [RouterModule.forChild(routes)],
        exports: [RouterModule]
    })
], FacilitiesRoutingModule);
export { FacilitiesRoutingModule };
//# sourceMappingURL=facilities-routing.module.js.map