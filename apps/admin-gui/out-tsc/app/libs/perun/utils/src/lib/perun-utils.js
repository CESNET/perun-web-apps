...
export function parseStatusIcon(richMember) {
 ...
 */
export function parseStatusColor(richMember) {
    switch (richMember.status) {
        case 'VALID':
            return 'accent';
        case 'INVALID':
 ...
 */
export function parseEmail(richMember) {
    let email = '';
    if (richMember) {
 ...
 */
export function parseUserEmail(richUser) {
    let email = '';
    if (richUser) {
...
export function parseUserLogins(richUser) {
    let logins = '';
 ...
 * @param richMember member
 */
export function parseLogins(richMember) {
    let logins = '';
    richMember.userAttributes.forEach(attr => {
...
export function parseUrnsToUrlParam(paramName, urns) {
    let attributesParam = '';
 ...
 * @param user user
 */
export function parseFullName(user) {
    let fullName = '';
 ...
 */
export function getRichUserAttribute(user, urn) {
...
export function parseTechnicalOwnersNames(owners) {
    let names = '';
...
export function doAfterDelay(delayMs, callback) {
 ...
 */
export function getRecentlyVisited(key, array) {
 ...
 */
export function getRecentlyVisitedIds(key) {
    const recentIds = JSON.parse(localStorage.getItem(key));
    if (recentIds) {
        return recentIds;
    }
 ...
 */
export function addRecentlyVisited(key, item) {
...
export function indexOfVo(recent, id) {
 ...
 * @param richUser RichUser
 */
export function parseVo(richUser) {
    let result = '';
    if (richUser) {
        richUser.userAttributes.forEach(attr => {
 ...
 */
export function filterCoreAttributes(attributes) {
 ...
 */
export function applyFilter(filterValue, groups) {
 ...
 */
export function findParent(group, groups) {
...
export function filterCoreAttributesDefinitions(attributesDef) {
 ...
 */
export function getAttribute(attributes, attrName) {
 ...
 */
export function getCandidateEmail(candidate) {
...
export function getExtSourceNameOrOrganizationColumn(candidate) {
 ...
 * @return
 */
export function convertCertCN(toConvert) {
...
export function unescapeDN(string) {
    return decodeURIComponent(string.replace(/\\x/g, '%'));
}
export function translateIdp(name) {
    switch (name) {
...
export function createNewApplicationMail() {
...
export function createNewApplicationFormItem() {
...
//# sourceMappingURL=perun-utils.js.map