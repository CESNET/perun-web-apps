...
let PerunSharedComponentsModule = class PerunSharedComponentsModule {
};
PerunSharedComponentsModule = __decorate([
    NgModule({
        imports: [
            CommonModule,
            MatCheckboxModule,
...
export { PerunSharedComponentsModule };
//# sourceMappingURL=perun-components.module.js.map