...
@Component({
  ...
  standalone: true,
  selector: 'app-vo-applications-new-reg',
  templateUrl: './vo-applications-new-reg.component.html',
  styleUrls: ['./vo-applications-new-reg.component.scss'],
})
export class VoApplicationsNewRegComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.cacheHelperService
      ...
      .subscribe((nextValue) => {
        if (nextValue === VoApplicationsNewRegComponent.id) {
