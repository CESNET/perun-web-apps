...
@Component({
  ...
  styleUrls: ['./group-applications-new-reg.component.scss'],
})
export class GroupApplicationsNewRegComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.cacheHelperService
      ...
      .subscribe((nextValue) => {
        if (nextValue === GroupApplicationsNewRegComponent.id) {
